package com.comet.androidstreamingui.library;
...
/**
 * Created by Everglowing Comet on 8/18/19.
 */
...
public class VLCVideoPlayer extends FrameLayout implements
    ...
    protected void onFinishInflate() {
        ...
        mRefreshButton = (ImageButton) mVideoFrame.findViewById(R.id.refresh_button);
